...
| 0xC45 | URO | mkrsh  | Fold/unfold Kernel shape
| 0xC46 | URO | mfdsh  | Fold/unfold data shape
| 0xC47 | URO | mpad   | Fold/unfold padding and sliding strides
| 0xC48 | URO | mstdi  | Fold/unfold sliding strides and dilations
| 0xC49 | URO | msk    | Fold/unfold sliding kernel position
|===


.`mkrsh` register layout
[cols="^2,^2,8"]
|===
|     Bits | Name       | Description

|  XLEN:32 | 0          | Reserved
|    31:16 | krshape[1] | Kernel shape of dim 1, height
|     15:0 | krshape[0] | Kernel shape of dim 0, width
|===

.`mfdsh` register layout
[cols="^2,^2,8"]
|===
|     Bits | Name       | Description

|  XLEN:32 | 0          | Reserved
|    31:16 | fdshape[1] | Folded data shape of dim 1, height
|     15:0 | fdshape[0] | Folded data shape of dim 0, width
|===
...
|  XLEN:32 | 0           | Reserved
|    15:12 | mdil_h      | Height spacing of the kernel elements
|     11:8 | mdil_w      | Weight spacing of the kernel elements
|      7:4 | mstr_h      | Height stride of the convolution
|      3:0 | mstr_w      | Weight stride of the convolution
|===
...
```
msetkrsh rd, rs1, rs2   # set kernel shape(rs1), strides and dilations(rs2)
msetfdsh rd, rs1, rs2   # set fold/unfold shape and padding(rs1)

msetsk rd, rs1          # set fold/unfold sliding kernel position
```
...
| 2    | msetkrsh       | 1000    | 000 | rs2   | rs1   | 111    | rd   | 1110111
| 4    | msetfdsh       | 1001    | 000 | rs2   | rs1   | 111    | rd   | 1110111
...
2+|**Load**            ^| funct6 | ls   | rs2   | rs1   | eew    | md   | opcode
| 1    | mlufae8.m      | 110000 | 0    | rs2   | rs1   | 000    | md   | 1110111
| 2    | mlufae16.m     | 110000 | 0    | rs2   | rs1   | 001    | md   | 1110111
| 3    | mlufae32.m     | 110000 | 0    | rs2   | rs1   | 010    | md   | 1110111
| 4    | mlufae64.m     | 110000 | 0    | rs2   | rs1   | 011    | md   | 1110111
| 5    | mlufbe8.m      | 110001 | 0    | rs2   | rs1   | 000    | md   | 1110111
| 6    | mlufbe16.m     | 110001 | 0    | rs2   | rs1   | 001    | md   | 1110111
| 7    | mlufbe32.m     | 110001 | 0    | rs2   | rs1   | 010    | md   | 1110111
| 8    | mlufbe64.m     | 110001 | 0    | rs2   | rs1   | 011    | md   | 1110111
| 9    | mlufce8.m      | 110010 | 0    | rs2   | rs1   | 000    | md   | 1110111
| 10   | mlufce16.m     | 110010 | 0    | rs2   | rs1   | 001    | md   | 1110111
| 11   | mlufce32.m     | 110010 | 0    | rs2   | rs1   | 010    | md   | 1110111
| 12   | mlufce64.m     | 110010 | 0    | rs2   | rs1   | 011    | md   | 1110111

2+|**Store**           ^| funct6 | ls   | rs2   | rs1   | eew    | ms3  | opcode
| 13   | msfdae8.m      | 110000 | 1    | rs2   | rs1   | 000    | ms3  | 1110111
| 14   | msfdae16.m     | 110000 | 1    | rs2   | rs1   | 001    | ms3  | 1110111
| 15   | msfdae32.m     | 110000 | 1    | rs2   | rs1   | 010    | ms3  | 1110111
| 16   | msfdae64.m     | 110000 | 1    | rs2   | rs1   | 011    | ms3  | 1110111
| 17   | msfdbe8.m      | 110001 | 1    | rs2   | rs1   | 000    | ms3  | 1110111
| 18   | msfdbe16.m     | 110001 | 1    | rs2   | rs1   | 001    | ms3  | 1110111
| 19   | msfdbe32.m     | 110001 | 1    | rs2   | rs1   | 010    | ms3  | 1110111
| 20   | msfdbe64.m     | 110001 | 1    | rs2   | rs1   | 011    | ms3  | 1110111
| 21   | msfdce8.m      | 110010 | 1    | rs2   | rs1   | 000    | ms3  | 1110111
| 22   | msfdce16.m     | 110010 | 1    | rs2   | rs1   | 001    | ms3  | 1110111
| 23   | msfdce32.m     | 110010 | 1    | rs2   | rs1   | 010    | ms3  | 1110111
| 24   | msfdce64.m     | 110010 | 1    | rs2   | rs1   | 011    | ms3  | 1110111
...
void conv2d_float16(c, a, b, outh, outw, outc, inh, inw, inc,
    ...
    // set kernel shape, sliding strides and dilations, and padding
    msetkrsh(kh << 16 | kw, dilh << 12 | dilw << 8 | sh << 4 | sw);
    msetfdsh(inh << 16 | inw, pt << 24 | pb << 16 | pl << 8 | pr);
        ...
        for (j=0; j<n; j+=tile_n) {             // loop at dim n with tiling
            ...
            for (skh=0; skh<kh; skh++) {        // loop for kernel height
                ...
                for (skw=0; skw<kw; skw++) {    // loop for kernel width
                    ...
                    msetsk(inh_pos << 16 | inw_pos);     // set sliding kernel position
...
void conv3d_float16(c, a, b, outh, outw, outc, ind, inh, inw, inc,
    ...
    // set kernel shape, sliding strides and dilations, and padding
    msetkrsh(kd << 24 | kh << 16 | kw, dilh << 12 | dilw << 8 | sh << 4 | sw);
    msetfdsh(inh << 16 | inw, pt << 24 | pb << 16 | pl << 8 | pr);
            ...
            for (skd=0; skd<kd; skd++) {        // loop for kernel *depth*
                for (skh=0; skh<kh; skh++) {        // loop for kernel height
                    ...
                    for (skw=0; skw<kw; skw++) {    // loop for kernel width
                        ...
                        msetsk(inh_pos << 16 | inw_pos);   // set sliding position
